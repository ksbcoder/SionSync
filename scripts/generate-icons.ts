...
// Badge monocromático: solo la nota musical en blanco sobre transparente.
// Android ignora el color del badge y usa únicamente la silueta, por eso
// no lleva fondo. Margen pequeño para que la nota llene la barra de estado.
function buildBadgeSvg(size: number) {
...
await sharp(Buffer.from(buildBadgeSvg(96))).png().toFile('public/icons/badge.png');

console.log('✓ public/icons/icon-192.png');
console.log('✓ public/icons/icon-512.png');
console.log('✓ public/icons/badge.png');
