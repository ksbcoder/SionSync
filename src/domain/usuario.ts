...
export type RoleName = 'admin' | 'gestor_alabanza' | 'miembro_alabanza' | 'miembro_nuevo';
...
export const ROLES_INFO: Record<RoleName, { label: string; description: string; color: string }> = {
  ...
  miembro_nuevo: { label: 'Miembro Nuevo', description: 'Pendiente de promoción', color: 'bg-blue-100 text-blue-800' },
};
